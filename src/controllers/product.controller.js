...
const addProduct = asyncHandler(async(req, res)=>{
    ...
    const {name, description, price, stock, brand} = data;
    const  {_id} = req.user;
    console.log(data)
    ...
    return res.status(400).json(new ApiResponse(202, product,"Product Created Successfully."))
})
...
export {addProduct, removeProduct, getAllProducts, getProduct, addToCart, removeFromCart}
